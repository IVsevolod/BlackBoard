...
<div class="site-about">
    ...
    <p>Объявление можете разместить <?= Html::a('по адресу', 'http://sdrd.ru/advert/create') ?></p>

    <p>Чтобы просмотреть все объявления перейдите <?= Html::a('по ссылке', 'http://sdrd.ru') ?></p>
</div>
